 ...
 * @author pc
 */
public class dencr extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("dencrypt.html");
                rd.include(request,response);
            String str;
            str = request.getParameter("dencrypt");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet dencr</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<div style=\" overflow-x:scroll;\n" +
"  overflow-y:hidden;\n" +
"  display: flex;\">");
            out.println("<h1 style=\"padding-left:4%;\"><i>Your Message is : </i>" + ans + "</h1>");
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
        }
